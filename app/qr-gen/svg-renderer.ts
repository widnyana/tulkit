/**
 * SVG path generation for styled QR codes
 * Adapted from react-native-qrcode-skia for browser compatibility
 */
...
export function transformMatrixIntoPath(
  matrix: (1 | 0)[][],
  size: number,
  ...
  const renderElement = (
    ...
    switch (currentShape) {
      ...
      default: // this handle square too
